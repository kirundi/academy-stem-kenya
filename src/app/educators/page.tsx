      ...
      <main className="flex-1">
        ...
        <section className="px-6 py-20 lg:py-28">
          <div className="mx-auto max-w-5xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-[rgba(45,212,191,0.1)] border border-(--border-accent) px-3 py-1 text-xs font-bold uppercase tracking-wider text-(--primary-green) mb-6">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                ...
                className="rounded-xl bg-(--primary-green) px-8 py-4 text-lg font-bold text-[#10221c] shadow-lg shadow-[rgba(45,212,191,0.2)] hover:scale-[1.02] transition-transform"
              >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-[rgba(45,212,191,0.1)] flex items-center justify-center mb-4">
        ...
        <section className="py-20 px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Link
              href="/register/teacher"
              className="inline-block rounded-xl bg-(--primary-green) px-10 py-4 text-lg font-bold text-[#10221c] shadow-lg shadow-[rgba(45,212,191,0.2)] hover:scale-[1.02] transition-transform"
            >
