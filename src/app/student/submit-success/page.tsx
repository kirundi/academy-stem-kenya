    ...
    <div className="min-h-screen bg-[#10221c] flex flex-col items-center relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10 max-w-3xl w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
          <Link href="/student/dashboard" className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#13eca4] text-[#10221c] font-bold rounded-xl hover:opacity-90 transition-opacity shadow-lg shadow-[rgba(19,236,164,0.2)] text-sm">
            <span className="material-symbols-outlined text-[20px]">rocket_launch</span>
            Next Course
          </Link>
          <Link href="/student/portfolio" className="flex-1 flex items-center justify-center gap-2 py-4 bg-[rgba(19,236,164,0.08)] text-[#13eca4] border border-[rgba(19,236,164,0.2)] font-bold rounded-xl hover:bg-[rgba(19,236,164,0.12)] transition-colors text-sm">
