          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-[#1a2e27] border border-[rgba(19,236,164,0.08)] rounded-2xl p-5 flex-1">
              ...
              <div className="space-y-3">
                ...
                <Link href="/student/progress" className="flex items-center gap-1 text-[#13eca4] text-xs font-bold hover:underline">View Full Progress<span className="material-symbols-outlined text-[14px]">arrow_forward</span></Link>
              </div>
            </div>
          </div>
        </div>
