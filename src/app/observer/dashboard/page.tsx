  ...
  return (
    <div className="min-h-screen bg-[#10221c]">
      <header className="sticky top-0 z-10 bg-[rgba(16,34,28,0.8)] backdrop-blur-md border-b border-[rgba(6,182,212,0.1)] px-8 h-16 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-white">School Overview</h1>
      ...
      <div className="px-8 py-8">
        ...
        <div className="relative bg-linear-to-r from-[#1a2e27] to-[#162820] rounded-2xl p-8 mb-8 border border-[rgba(6,182,212,0.15)] overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-bold text-white mb-1">Welcome, {displayName.split(" ")[0]}</h2>
            ...
            {schools.map((school) => {
              ...
              return (
                <details key={school.id} className="bg-[#1a2e27] rounded-2xl border border-[rgba(6,182,212,0.08)] hover:border-[rgba(6,182,212,0.2)] transition-all p-5 cursor-pointer group [&_summary]:list-none">
                  ...
                  {/* Stats */}
                  <div className="grid grid-cols-3 gap-2 border-t border-[rgba(255,255,255,0.05)] pt-4">
                    {[
