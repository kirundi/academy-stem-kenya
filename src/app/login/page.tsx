        ...
        <div className="max-w-130 w-full bg-[rgba(255,255,255,0.03)] backdrop-blur-xl border border-(--border-subtle) p-8 md:p-12 rounded-3xl shadow-2xl">
          ...
          <div className="flex rounded-xl bg-(--glass-bg) border border-(--border-subtle) p-1 mb-8">
            ...
            <button
              ...
              className={`flex-1 h-10 rounded-lg text-sm font-bold transition-all ${
                emailMode ? "bg-primary-green text-white shadow" : "text-(--text-muted) hover:text-(--text-base)"
              }`}
            >
              Email Login
            </button>
            ...
            <div className="mb-8">
                    ...
                    <input
                      ...
                      className={`w-12 md:w-14 h-16 text-center bg-(--input-bg) border-2 text-2xl font-bold text-(--text-base) rounded-xl transition-all outline-none placeholder:text-(--text-faint) ${
                        val
                          ...
                          : "border-(--border-subtle) focus:border-primary-green focus:bg-primary-green/4"
                      }`}
                    />
                  </span>
                ))}
              ...
              {verifiedStudent && (
                <div className="rounded-xl p-4 mb-6 border bg-[rgba(19,236,164,0.05)] border-(--border-accent)">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary-green/15 flex items-center justify-center shrink-0">
              ...
              {verifiedStudent ? (
                <button
                  ...
                  disabled={loading}
                  className="w-full h-14 rounded-xl font-bold text-lg flex items-center justify-center gap-3 transition-all bg-primary-green text-white hover:opacity-90 shadow-lg shadow-primary-green/20 disabled:opacity-50"
                >
                  {loading ? (
                    <span className="material-symbols-outlined animate-spin text-(--text-base)">
                      progress_activity
                    </span>
                  ) : (
                    <>
                ...
                <button
                  ...
                  className={`w-full h-14 rounded-xl font-bold text-lg flex items-center justify-center gap-3 transition-all ${
                    formReady
                      ? "bg-primary-green text-white hover:opacity-90 shadow-lg shadow-primary-green/20"
                      : "bg-primary-green/30 text-(--text-base)/50 cursor-not-allowed"
                  }`}
                >
                  {verifying ? (
                    <span className="material-symbols-outlined animate-spin text-(--text-base)">
