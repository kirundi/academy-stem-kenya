    ...
    <div className="flex h-screen bg-[#10221c] overflow-hidden">
      ...
      <main className="ml-60 flex-1 overflow-y-auto">
        <header className="sticky top-0 z-10 bg-[rgba(16,34,28,0.85)] backdrop-blur-md border-b border-[rgba(59,130,246,0.08)] px-6 py-3">
          ...
          <p className="text-slate-400 text-xs">Manage your support account</p>
        </header>
            ...
            {activeTab === "account" && (
              <div className="bg-[#1a2e27] rounded-xl border border-slate-800 p-7">
                ...
                <div className="mt-5 p-4 rounded-xl border" style={{ background: `${ACCENT}10`, borderColor: `${ACCENT}30` }}>
                  ...
                  <p className="text-slate-400 text-xs">Support accounts have view-only access. Contact a platform admin to make user changes.</p>
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-[#1a2e27] rounded-xl border border-slate-800 p-7">
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#102022]/50 rounded-xl border border-slate-700">
                    ...
                    <a href="/auth/change-password" className="px-4 py-2 bg-[#1a2e27] border border-slate-700 text-slate-200 text-sm font-bold rounded-lg hover:border-[rgba(59,130,246,0.5)] transition-colors">
                      Change Password
                    </a>
                  </div>
                </div>
                  ...
                  {sessionsLoading ? (
                    ...
                    <div className="space-y-3">
                      {sessions.map((s) => {
                        ...
                        return (
                          <div key={s.id} className={`flex items-center justify-between p-4 rounded-xl border ${isCurrent ? "bg-[rgba(59,130,246,0.04)]" : "bg-[#102022]/50 border-slate-700"}`} style={isCurrent ? { borderColor: `${ACCENT}30` } : {}}>
