...
export default function SchoolAnalyticsPage() {
  ...
  const departments = Array.from(deptMap.entries())
    ...
    .slice(0, 4)
    .map((entry, i) => {
      const colors = ["#2dd4bf", "#3b82f6", "#8b5cf6", "#f59e0b"];
      return {
        name: entry[0],
        count: entry[1],
    ...
    <div className="min-h-screen bg-(--bg-page) flex flex-col">
      ...
      <header className="sticky top-0 z-10 bg-[rgba(16,34,28,0.9)] backdrop-blur-md border-b border-(--border-subtle) px-8 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-9 h-9 rounded-full bg-[rgba(45,212,191,0.1)] border-2 border-(--border-accent)" />
        </div>
      </header>
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-56 border-r border-(--border-subtle) p-4 flex flex-col gap-4 shrink-0">
          ...
          <div className="mt-auto p-4 rounded-xl bg-[rgba(45,212,191,0.05)] border border-(--border-medium)">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="flex flex-wrap justify-between items-center gap-4 px-8 py-6 border-b border-(--border-subtle)">
            ...
            <div className="flex gap-3">
              ...
              <button className="flex items-center gap-2 h-11 px-6 rounded-xl bg-(--primary-green) text-[#10221c] text-sm font-bold hover:opacity-90 transition-opacity">
