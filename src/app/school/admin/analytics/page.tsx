      ...
      <header className="sticky top-0 z-10 bg-[rgba(16,34,28,0.9)] backdrop-blur-md border-b border-[rgba(19,236,164,0.08)] px-8 h-14 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="/school/admin" className="text-slate-400 hover:text-[#13eca4] transition-colors font-medium">Overview</a>
            <a href="/school/admin/classrooms" className="text-slate-400 hover:text-[#13eca4] transition-colors font-medium">Classrooms</a>
            <a href="/school/admin/teachers" className="text-slate-400 hover:text-[#13eca4] transition-colors font-medium">Teachers</a>
            <a href="/school/admin/students" className="text-slate-400 hover:text-[#13eca4] transition-colors font-medium">Students</a>
          </nav>
        </div>
          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="bg-[#1a2e27] rounded-2xl border border-[rgba(19,236,164,0.07)] overflow-hidden pb-6">
              <div className="px-6 py-5 border-b border-[rgba(255,255,255,0.06)] flex justify-between items-center">
                ...
                <a href="/school/admin/classrooms" className="text-[#13eca4] text-sm font-semibold hover:underline">View All</a>
              </div>
