      ...
      <main className="ml-60 flex-1 overflow-y-auto">
        ...
        <div className="px-8 py-8 space-y-6">
          {loading ? (
            ...
            <>
              {/* Stat card */}
              <div className="flex items-center gap-4 p-5 bg-(--bg-card) rounded-2xl border border-[rgba(45,212,191,0.08)] max-w-xs">
                <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0 bg-[rgba(45,212,191,0.12)]">
              ...
              {filtered.length === 0 ? (
                ...
                <div className="bg-(--bg-card) rounded-2xl border border-[rgba(45,212,191,0.08)] overflow-hidden">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-[rgba(45,212,191,0.08)]">
                    ...
                    <tbody className="divide-y divide-[rgba(45,212,191,0.05)]">
                      {filtered.map((parent) => {
                        ...
                        return (
                          <tr
                            key={parent.uid}
                            className="hover:bg-[rgba(45,212,191,0.03)] transition-colors"
                          >
                            <td className="px-5 py-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-[rgba(45,212,191,0.12)] flex items-center justify-center text-(--primary-green) text-xs font-bold shrink-0">
                                  {initials}
                                </div>
                            ...
                            <td className="px-5 py-4">
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold bg-[rgba(45,212,191,0.10)] text-(--primary-green)">
