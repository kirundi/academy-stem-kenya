              ...
              <button
                ...
                className={`pb-4 border-b-2 font-bold text-sm transition-colors ${
                  activeTab === tab.key
                    ...
                    : "border-transparent text-slate-500 hover:text-(--text-muted)"
                }`}
              >
                {tab.label}
              </button>
            ...
            <div className="space-y-10">
              <section>
                ...
                <div className="aspect-video w-full rounded-xl bg-(--bg-card) border border-[rgba(19,236,164,0.1)] overflow-hidden relative group flex items-center justify-center">
                  ...
                  <div className="absolute bottom-4 left-4 bg-(--bg-page)/80 px-3 py-1 rounded text-xs font-medium border border-[rgba(19,236,164,0.2)] text-primary-green">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {resources.map((r) => (
                    <div
                      key={r.title}
                      className="p-4 rounded-xl border border-[rgba(19,236,164,0.1)] bg-(--bg-page) hover:border-primary-green/40 transition-colors flex items-start gap-4 group cursor-pointer"
                    >
          ...
          <section>
            ...
            <div className="space-y-3">
              {team.map((m) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="size-8 rounded-full bg-(--bg-card) border border-[rgba(19,236,164,0.3)] flex items-center justify-center text-[10px] font-bold text-primary-green">
                      {m.initials}
                    </div>
            ...
            <button className="w-full mt-4 py-2 text-xs font-bold border border-[rgba(19,236,164,0.2)] rounded-lg hover:bg-primary-green/5 transition-colors text-primary-green">
              Open Team Chat
            </button>
          </section>
