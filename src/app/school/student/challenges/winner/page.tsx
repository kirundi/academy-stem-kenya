  ...
  return (
    <div className="min-h-screen bg-[#0a1a16] text-(--text-base) relative overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Top nav */}
        <header className="flex items-center gap-6 px-8 py-5 border-b border-[rgba(45,212,191,0.12)] bg-(--bg-page)/80 backdrop-blur-sm">
          <Link
          ...
          <div className="h-4 w-px bg-[rgba(45,212,191,0.2)]" />
          <span className="text-sm font-semibold text-(--text-base)">{challengeTitle}</span>
          <Link
        ...
        <div className="px-8 pb-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 lg:col-span-5 flex flex-col items-center gap-8">
              ...
              <div className="flex gap-3 w-full max-w-xs">
                ...
                <Link
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 bg-(--bg-card) border border-[rgba(45,212,191,0.2)] text-(--text-base) rounded-xl font-bold text-sm hover:bg-[#243d40] transition-colors"
                >
            ...
            <div className="col-span-12 lg:col-span-7">
              <div className="w-full aspect-[1.414/1] relative bg-(--bg-page) border border-[rgba(45,212,191,0.2)] rounded-2xl overflow-hidden shadow-2xl">
                {/* Corner decorations */}
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center px-12 py-8 bottom-12">
                  <div className="text-center mb-4">
                    ...
                    <div className="w-20 h-px bg-linear-to-r from-transparent via-(--primary-green)/60 to-transparent mx-auto mb-4" />
                  </div>
                  ...
                  <div className="w-full grid grid-cols-3 items-end gap-4 mt-auto">
                    <div className="text-center">
                      <p className="text-[10px] text-(--text-faint) mb-1">Date Awarded</p>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-[9px] text-(--text-faint) mt-1">Academy Seal</p>
                    </div>
                    <div className="text-center">
                      <p className="text-xs font-bold italic">STEM Impact Center</p>
                      <p className="text-[10px] text-(--text-faint)">Global Admin</p>
                    </div>
                  </div>
                </div>

                {/* Footer bar with verify ID */}
                <div className="absolute bottom-0 left-0 right-0 h-12 bg-[#0a1a16]/80 border-t border-[rgba(45,212,191,0.12)] flex items-center justify-between px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-10">
            {stats.map((s) => (
              <div
                key={s.label}
                className="flex items-start gap-4 p-5 bg-(--bg-page) rounded-2xl border border-[rgba(45,212,191,0.1)] hover:border-(--primary-green)/30 transition-colors"
              >
