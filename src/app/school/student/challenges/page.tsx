        ...
        <div className="px-8 pt-8 pb-4 flex justify-between items-start">
          <div>
            ...
            <p className="text-slate-400 max-w-lg text-sm">
              Conquer time-bound coding challenges, build high-impact solutions, and rise through the ranks.
            </p>
          </div>
            ...
            <div className="col-span-8 space-y-10">
              ...
              <section>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="text-[#13eca4] text-sm font-medium hover:underline">View archive</button>
                </div>
                  ...
                  <div className="grid grid-cols-2">
                    <div className="p-8 flex flex-col justify-between">
                      <div>
                        ...
                        <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                          Design and prototype a decentralized application to track and offset carbon footprints for urban communities.
                        </p>
                      ...
                      <div className="space-y-4">
                        <p className="text-[10px] uppercase font-bold tracking-[0.2em] text-red-400">Submission Deadline In</p>
                        <div className="flex gap-3">
                          {[
                            ...
                            <div key={i} className="flex flex-col items-center">
                              <div className={`w-14 h-14 rounded-xl flex items-center justify-center border border-white/10 ${i === 1 ? "bg-[#1a2e30] text-[#13eca4]" : "bg-[#243d40]"}`}>
                                <span className="text-xl font-bold text-white">{t.v}</span>
                              </div>
                              <span className="text-[10px] mt-1 text-slate-500 uppercase">{t.l}</span>
                            </div>
                          ))}
                        </div>
                        <Link
                    ...
                    <div className="relative min-h-95 bg-linear-to-br from-[#13eca4]/20 via-[#0d2420] to-[#102022]">
                      <div className="absolute inset-0 flex items-center justify-center opacity-20">
                        <span className="material-symbols-outlined text-[#13eca4]" style={{ fontSize: "220px" }}>eco</span>
                      </div>
                  ...
                  {[
                    ...
                    >
                      <div className="absolute inset-0 flex items-center justify-center opacity-10">
                        <span className="material-symbols-outlined text-white" style={{ fontSize: "180px" }}>{c.icon}</span>
                      </div>
            ...
            <div className="col-span-4 space-y-6">
              ...
              <div className="bg-[#1a2e30] rounded-2xl border border-[rgba(19,236,164,0.1)] overflow-hidden">
                <div className="p-6 border-b border-white/5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold flex items-center gap-2">
                      <span className="material-symbols-outlined text-[#13eca4] text-lg">stars</span>
                      School Leaderboard
                    </h3>
                  ...
                  <div className="flex justify-around items-end pt-4 pb-2">
                    {[leaderboardTop3[0], leaderboardTop3[1], leaderboardTop3[2]].map((p) => (
                      <div key={p.rank} className={`flex flex-col items-center gap-2 ${p.rank === 1 ? "mb-4" : ""}`}>
                        ...
                        <span className={`text-[10px] font-medium ${p.rank === 1 ? "font-bold text-[#13eca4]" : ""}`}>{p.name}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="divide-y divide-white/5">
                  {leaderboardRest.map((r) => (
                    ...
                    >
                      ...
                      <span className={`text-sm font-${r.isMe ? "bold" : "medium"} flex-1 ${r.isMe ? "text-white" : "text-slate-400"}`}>
                        {r.name}
                      </span>
                      <span className={`text-xs font-mono font-bold ${r.isMe ? "text-[#13eca4]" : "text-slate-500"}`}>
                ...
                <div className="p-4 text-center border-t border-white/5">
                  <Link href="/school/student/challenges/leaderboard" className="text-[10px] text-[#13eca4] font-bold hover:tracking-widest transition-all uppercase">
                    See Full Rankings
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-[#1a2e30] rounded-2xl p-5 border border-red-500/20">
                ...
                <div className="aspect-video bg-black rounded-xl overflow-hidden relative border border-white/5">
                  ...
                  <div className="absolute top-2 left-2 flex items-center gap-2">
                    <span className="bg-red-500 text-[8px] font-black text-white px-1.5 py-0.5 rounded uppercase">Live</span>
                    <span className="text-[10px] text-white/80 backdrop-blur-md px-1.5 py-0.5 rounded bg-black/40">150 watching</span>
                  </div>
                </div>
                <p className="text-xs mt-2 text-slate-400">Mentors are helping with Eco-Hack API integration right now.</p>
              </div>
            </div>
          </div>
        </div>
