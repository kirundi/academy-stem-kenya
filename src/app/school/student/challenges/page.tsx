              ...
              <div className="col-span-12 xl:col-span-8 space-y-10">
                ...
                {liveChallenges.length > 0 && (
                  <section>
                    ...
                    {/* Hero Challenge Card */}
                    {heroChallenge && (
                      <div className="relative overflow-hidden rounded-2xl bg-(--bg-card) border border-(--border-strong) shadow-lg shadow-[rgba(45,212,191,0.1)]">
                        <div className="grid grid-cols-2">
                          ...
                          {/* Right visual */}
                          <div className="relative min-h-72 bg-linear-to-br from-(--primary-green)/20 via-[#0d2420] to-[#102022]">
