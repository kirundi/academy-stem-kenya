          ...
          <div className="xl:col-span-3">
            ...
            {completedCourse && (
              <div className="flex items-center gap-4 p-4 rounded-2xl mb-6 border border-[rgba(0,245,212,0.2)] bg-[rgba(0,245,212,0.03)]">
                ...
                <Link href="/school/student/submit-success" className="text-[#0a1a18] text-xs font-bold px-4 py-2 rounded-lg shrink-0 hover:opacity-90 transition-opacity" style={{ background: "#00f5d4" }}>
                  View Certificate
                </Link>
              </div>
            )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1a2e27] rounded-2xl p-5 border border-[rgba(19,236,164,0.08)]">
              ...
              <div className="space-y-2">
                {[
                  { icon: "military_tech", label: "View All Badges", href: "/school/student/badges", color: "#f59e0b" },
                  { icon: "grid_view", label: "My Portfolio", href: "/school/student/portfolio", color: "#8b5cf6" },
                  { icon: "insights", label: "My Progress", href: "/school/student/progress", color: "#13eca4" },
