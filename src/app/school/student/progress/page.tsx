        ...
        <div className="bg-linear-to-r from-[rgba(19,236,164,0.08)] to-[rgba(19,236,164,0.02)] border border-(--border-medium) rounded-3xl p-7 mb-8 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex items-center gap-5">
              <div className="w-20 h-20 rounded-2xl bg-primary-green/10 border-2 border-primary-green flex items-center justify-center">
              ...
              <div className="space-y-4">
                {milestones.map((m) => (
                  <div key={m.label} className="flex items-start gap-3 relative pl-1">
                    <div
                      className={`relative z-10 w-7 h-7 rounded-full flex items-center justify-center shrink-0 ${m.done ? "bg-primary-green/15" : "bg-(--input-bg)"}`}
                    >
                      <span
