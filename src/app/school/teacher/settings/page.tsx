                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-5">
                      <div className="flex items-center gap-3">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          />
                          <div
                            className={`w-11 h-6 rounded-full transition-colors after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:border after:border-gray-300 after:rounded-full after:h-5 after:w-5 after:transition-all ${autoSync ? "bg-primary-green after:translate-x-full" : "bg-slate-700"}`}
                          />
                        </label>
                      </div>
                      <button className="flex items-center gap-2 bg-(--bg-elevated) text-(--text-base) px-4 py-2 rounded-lg font-bold text-sm hover:bg-slate-700 transition-colors">
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input
                              ...
                              className="rounded border-(--border) text-primary-green focus:ring-[#13eca4] bg-transparent w-4 h-4 accent-primary-green"
                            />
                          ...
                          <button
                            ...
                            className="bg-primary-green hover:bg-[#0dd494] text-(--text-base) px-4 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1 transition-colors"
                          >
            ...
            {activeTab === "account" && (
              <div className="bg-(--bg-card) rounded-xl border border-(--border-subtle) p-7">
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    onClick={handleSave}
                    className="px-6 py-2.5 bg-primary-green text-white font-bold rounded-lg hover:opacity-90 transition-opacity"
                  >
                ...
                <div className="bg-(--bg-card) rounded-xl border border-(--border-subtle) p-7">
                  ...
                  <div className="flex items-center justify-between p-4 bg-(--bg-page)/50 rounded-xl border border-(--border)">
                    ...
                    <a
                      ...
                      className="px-4 py-2 bg-(--bg-card) border border-(--border) text-(--text-base) text-sm font-bold rounded-lg hover:border-[rgba(19,236,164,0.5)] transition-colors"
                    >
                      Change Password
                    </a>
                  </div>
