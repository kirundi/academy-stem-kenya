      ...
      <div className="fixed top-0 left-60 right-0 z-20 bg-[rgba(16,34,28,0.95)] backdrop-blur-md border-b border-(--border-subtle) h-14 flex items-center justify-between px-8">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 bg-[rgba(45,212,191,0.1)] rounded-lg flex items-center justify-center">
        ...
        <div className="flex items-center gap-5">
          ...
          <button
            ...
            disabled={finishing}
            className="px-5 h-9 bg-(--primary-green) text-[#10221c] text-sm font-bold rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
          >
              ...
              {[
                ...
                <label
                  ...
                  className={`group flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all ${
                    checklist[i]
                      ? "bg-[rgba(45,212,191,0.05)] border border-(--border-accent)"
                ...
                >
                  <input
                    ...
                    className="w-5 h-5 rounded border-(--border) bg-transparent text-(--primary-green) focus:ring-0 cursor-pointer"
                  />
          ...
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div
                      ...
                      className={`rounded-2xl p-5 flex flex-col gap-4 transition-all hover:shadow-xl ${
                        isDeprecated
                          ...
                          : "bg-(--bg-card) border border-(--border-subtle) hover:shadow-[rgba(45,212,191,0.05)]"
                      }`}
                    >
                      <div className="flex justify-between items-start">
                        <div
                          className={`w-12 h-12 rounded-xl flex items-center justify-center ${isDeprecated ? "bg-(--glass-bg)" : "bg-[rgba(45,212,191,0.1)]"}`}
                        >
                          <span
                ...
                {/* Add Module */}
                <button className="border-2 border-dashed border-(--border-subtle) rounded-2xl p-5 flex flex-col items-center justify-center gap-3 hover:border-[rgba(45,212,191,0.4)] hover:bg-[rgba(45,212,191,0.03)] transition-all group">
                  <div className="w-10 h-10 rounded-full bg-(--glass-bg) flex items-center justify-center text-(--text-muted) group-hover:text-(--primary-green) group-hover:bg-[rgba(45,212,191,0.1)] transition-colors">
