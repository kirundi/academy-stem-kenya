        ...
        <div className="px-4 py-4 border-b border-(--border-subtle)">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs font-bold text-(--primary-green) bg-[rgba(45,212,191,0.1)] px-2 py-1 rounded-lg hover:bg-[rgba(45,212,191,0.2)] transition-colors"
            >
            ...
            <div className="flex flex-wrap justify-between items-start gap-6 mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  disabled={syncing}
                  className="flex items-center justify-center gap-2 rounded-lg h-11 px-5 bg-(--primary-green) text-[#10221c] text-sm font-bold hover:opacity-90 transition-all shadow-lg shadow-[rgba(45,212,191,0.2)] disabled:opacity-50"
                >
                  <span
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 pb-3 pt-2 border-b-2 transition-all text-sm font-bold ${
                        activeTab === tab
                          ...
                          : "border-transparent text-(--text-faint) hover:text-(--text-muted) hover:border-(--border)"
                      }`}
                    >
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-(--primary-green) bg-[rgba(45,212,191,0.1)] px-4 py-2 rounded-lg text-sm font-bold hover:bg-[rgba(45,212,191,0.2)] transition-all"
                  >
                        ...
                        {rosterLoading ? (
                          ...
                          rosterStudents.map((student) => {
                            ...
                            return (
                              <tr
                                key={student.id}
                                className="hover:bg-[rgba(45,212,191,0.02)] transition-colors"
                              >
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-[rgba(45,212,191,0.15)] flex items-center justify-center text-(--primary-green) font-bold text-xs">
                                      {initials}
                                    </div>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-center">
                                  {(student.xp ?? 0) > 0 ? (
                                    ...
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-(--text-faint)/10 text-(--text-faint) border border-(--border)/20">
                                      New
                                    </span>
                                  )}
                                </td>
                    ...
                    <div className="flex items-end justify-center gap-2 h-24 mb-4">
                      {[60, 75, 85, 95, 50].map((h, i) => (
                        <div
                          ...
                          style={{
                            height: `${h}%`,
                            background: `rgba(45,212,191,${0.2 + i * 0.15})`,
                          }}
                        />
                      ))}
                    </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{ background: course.color || "#2dd4bf" }}
                        >
                    ...
                    <div className="space-y-3">
                      {classroomCourses.map((course) => (
                        <div key={course.id} className="flex items-center gap-3">
                          ...
                          <span className="ml-auto text-[10px] font-bold uppercase text-(--primary-green) bg-[rgba(45,212,191,0.1)] px-2 py-0.5 rounded shrink-0">
                            Active
                          </span>
                        </div>
                      ))}
