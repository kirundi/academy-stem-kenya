                ...
                return (
                  <div
                    ...
                    className={`bg-(--bg-page) border rounded-xl overflow-hidden transition-all group ${
                      enrolled
                        ? "border-primary-green/40 shadow-lg shadow-[#13eca4]/5"
                        : upcoming
                            ...
                            <div key={enr.id} className="flex items-center justify-between text-xs">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className={`w-8 h-4 rounded-full relative transition-colors ${enr.lateAccess ? "bg-primary-green" : "bg-slate-600"}`}
                                >
                                  <div
                        ...
                        <tr key={e.id}>
                          ...
                          <td className="px-6 py-4">
                            <button
                              ...
                              className={`w-10 h-5 rounded-full relative transition-colors ${e.lateAccess ? "bg-primary-green" : "bg-slate-600"}`}
                            >
                              <div
