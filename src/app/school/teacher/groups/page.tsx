...
const GROUP_COLORS = ["#2dd4bf", "#f59e0b", "var(--accent-red)", "#3b82f6", "#8b5cf6"];
        ...
        <div className="flex-1 overflow-y-auto p-8">
          {groups.length === 0 && !creatingGroup ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
              {groups.map((g) => (
                <div
                  ...
                  className={`bg-(--bg-card) rounded-2xl border transition-all cursor-pointer ${
                    activeGroup?.id === g.id
                      ? "border-[rgba(45,212,191,0.4)] shadow-lg shadow-[rgba(45,212,191,0.06)]"
                ...
                >
                  ...
                  <div className="p-4 space-y-2 max-h-44 overflow-y-auto">
                    ...
                    {(g.studentIds ?? []).map((sid) => (
                      ...
                      >
                        <div className="w-6 h-6 rounded-full bg-[rgba(45,212,191,0.1)] flex items-center justify-center text-[10px] font-bold text-(--primary-green) shrink-0">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-[rgba(45,212,191,0.25)] text-(--primary-green) hover:bg-(--primary-green)/10 transition-colors"
              ...
              <div
                onClick={handleCreateGroup}
                className="bg-[rgba(255,255,255,0.02)] border-2 border-dashed border-(--border-subtle) rounded-2xl p-5 flex flex-col items-center justify-center gap-3 h-40 hover:border-(--border-strong) hover:bg-[rgba(45,212,191,0.02)] transition-all cursor-pointer group"
              >
                <div className="w-10 h-10 rounded-full bg-(--input-bg) group-hover:bg-[rgba(45,212,191,0.1)] flex items-center justify-center transition-colors">
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2">
            ...
            {activeGroup &&
              unassignedStudents.map((s) => (
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-(--bg-elevated) flex items-center justify-center text-xs font-bold text-(--text-muted) group-hover:bg-[rgba(45,212,191,0.15)] group-hover:text-(--primary-green) transition-colors shrink-0">
                    {s.name[0]}
                  </div>
