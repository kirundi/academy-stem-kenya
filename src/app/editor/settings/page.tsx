...
const ACCENT = "#ec4899";
const ACCENT_BG = "rgba(236,72,153,0.1)";

const NOTIFICATIONS = [
  { label: "Course review feedback", desc: "When a reviewer approves or returns your course" },
  { label: "Course published", desc: "When your submitted course goes live" },
  { label: "Platform updates", desc: "New features, guidelines, and announcements" },
];
              ...
              <div className="space-y-6">
                <div className="bg-(--bg-card) rounded-xl border border-(--border-subtle) p-7">
                  ...
                  <div className="flex items-center justify-between p-4 bg-(--bg-page)/50 rounded-xl border border-(--border)">
                    ...
                    <a href="/auth/change-password" className="px-4 py-2 bg-(--bg-card) border border-(--border) text-(--text-base) text-sm font-bold rounded-lg hover:border-[rgba(236,72,153,0.5)] transition-colors">
                      Change Password
                    </a>
                  </div>
                </div>
