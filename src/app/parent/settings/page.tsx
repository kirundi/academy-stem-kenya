              ...
              <div className="space-y-6">
                <div className="bg-(--bg-card) rounded-xl border border-(--border-subtle) p-7">
                  ...
                  <div className="flex items-center justify-between p-4 bg-(--bg-page)/50 rounded-xl border border-(--border)">
                    ...
                    <a href="/auth/change-password" className="px-4 py-2 bg-(--bg-card) border border-(--border) text-(--text-base) text-sm font-bold rounded-lg hover:border-[rgba(139,92,246,0.5)] transition-colors">
                      Change Password
                    </a>
                  </div>
                </div>
                  ...
                  {sessionsLoading ? (
                    ...
                    <div className="space-y-3">
                      {sessions.map((s) => {
                        ...
                        return (
                          <div key={s.id} className={`flex items-center justify-between p-4 rounded-xl border ${isCurrent ? "bg-[rgba(139,92,246,0.04)]" : "bg-(--bg-page)/50 border-(--border)"}`} style={isCurrent ? { borderColor: `${ACCENT}30` } : {}}>
