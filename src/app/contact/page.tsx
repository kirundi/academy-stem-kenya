        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-primary-green/10 flex items-center justify-center mx-auto mb-4">
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-primary-green py-4 text-(--text-base) font-bold hover:opacity-90 transition-opacity disabled:opacity-60 flex items-center justify-center gap-2"
                >
                  {status === "submitting" ? (
                    <>
