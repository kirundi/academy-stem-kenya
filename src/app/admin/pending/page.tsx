      ...
      <main className="px-6 md:px-20 py-10 max-w-5xl mx-auto">
        ...
        <section className="relative overflow-hidden rounded-2xl bg-[#1a2e27] border border-[rgba(19,236,164,0.1)] mb-10">
          <div
            ...
            style={{ backgroundImage: "radial-gradient(circle at 2px 2px, #13eca4 1px, transparent 0)", backgroundSize: "24px 24px" }}
          />
          <div className="relative p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="relative w-48 h-48 md:w-64 md:h-64 flex-shrink-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="material-symbols-outlined text-[#13eca4] text-[80px] md:text-[96px]">verified_user</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="grid grid-cols-[40px_1fr] gap-x-4">
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 rounded-full bg-[rgba(19,236,164,0.1)] border border-[rgba(19,236,164,0.4)] text-[#13eca4] flex items-center justify-center">
                      <span className="material-symbols-outlined text-[16px]" style={{ animation: "spin 1s linear infinite" }}>sync</span>
                    </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#1a2e27] rounded-2xl border border-[rgba(19,236,164,0.08)] overflow-hidden">
              <div className="px-6 py-5 border-b border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] flex items-center gap-4">
                <div className="w-16 h-16 rounded-xl bg-[rgba(19,236,164,0.1)] border border-[rgba(19,236,164,0.2)] flex items-center justify-center">
                  <span className="material-symbols-outlined text-[#13eca4] text-[32px]">corporate_fare</span>
                </div>
                <div>
                  <h3 className="text-white font-bold text-lg leading-none mb-1">Horizon Academy of STEM</h3>
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                {profileFields.map((f) => (
                  <div key={f.label}>
                    <p className="text-slate-500 text-xs uppercase font-bold tracking-wider mb-1">{f.label}</p>
                    <p className="text-white font-medium">{f.value}</p>
                  </div>
                ))}
                <div className="md:col-span-2">
                  <p className="text-slate-500 text-xs uppercase font-bold tracking-wider mb-1">Mailing Address</p>
                  <p className="text-white font-medium">1200 Innovation Way, Silicon Forest, WA 98004, USA</p>
                </div>
                <div className="md:col-span-2">
                  <p className="text-slate-500 text-xs uppercase font-bold tracking-wider mb-2">Supporting Documents</p>
                  <div className="flex flex-wrap gap-2">
                    {["School Accreditation Certificate", "Administrator ID"].map((doc) => (
                      <div key={doc} className="flex items-center gap-2 px-3 py-2 bg-[rgba(255,255,255,0.04)] rounded-lg text-sm border border-[rgba(255,255,255,0.08)]">
                        <span className="material-symbols-outlined text-[#13eca4] text-[16px]">description</span>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/onboarding" className="flex items-center gap-2 px-5 py-2.5 border border-[rgba(19,236,164,0.3)] text-[#13eca4] font-semibold rounded-xl hover:bg-[rgba(19,236,164,0.05)] transition-colors text-sm">
                <span className="material-symbols-outlined text-[18px]">arrow_back</span>Back to Form
              </Link>
            </div>
          </div>
        </div>
