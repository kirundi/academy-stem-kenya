      ...
      <header className="sticky top-0 z-10 bg-[rgba(16,34,28,0.9)] backdrop-blur-md border-b border-[rgba(19,236,164,0.08)] px-8 h-14 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="/admin/school/classrooms" className="text-slate-400 hover:text-[#13eca4] font-medium transition-colors">Curriculum</a>
            <a href="/admin/school/students" className="text-slate-400 hover:text-[#13eca4] font-medium transition-colors">Students</a>
            <a href="/admin/school/analytics" className="text-slate-400 hover:text-[#13eca4] font-medium transition-colors">Analytics</a>
          </nav>
        </div>
        <div className="flex items-center gap-3">
