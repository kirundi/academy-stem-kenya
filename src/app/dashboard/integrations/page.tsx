...
const STATUS_CONFIG = {
  ...
  inactive: { label: "Inactive", color: "text-(--text-faint)", dot: "bg-(--text-faint)", pulse: false },
};
        ...
        <div className="flex-1 flex flex-col gap-6 min-w-0">
          ...
          <section className="bg-(--bg-card)/40 border border-(--border) rounded-2xl p-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-lg bg-(--bg-card) border border-(--border) text-(--text-base) focus:ring-(--primary) focus:border-(--primary) h-12 px-4 font-mono text-sm pr-10 focus:outline-none"
                  />
                  <button
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button
                onClick={handleSave}
                className="px-6 py-2 bg-(--primary) text-[#102022] font-bold rounded-lg text-sm hover:brightness-110 transition-all"
              >
