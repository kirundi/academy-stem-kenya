...
const classrooms = [
  {
    ...
    trend: "+3%",
    trendUp: true,
    rankColor: "text-amber-400 bg-amber-400/10",
  },
  {
    rank: 2,
    name: "Data Science IB",
    dept: "Data Sci",
    teacher: "Prof. Alan Turing",
    score: 94.2,
    trend: "+1%",
    trendUp: true,
    rankColor: "text-slate-400 bg-slate-400/10",
  },
  {
    rank: 3,
    name: "Adv. Coding III",
    ...
    trend: "-0.5%",
    trendUp: false,
    rankColor: "text-orange-400 bg-orange-400/10",
  },
  {
    rank: 4,
    name: "BioTech Lab A",
    ...
    trend: "+4%",
    trendUp: true,
    rankColor: "text-slate-500 bg-slate-500/10",
  },
];
          ...
          <div className="flex flex-wrap justify-between items-center gap-4 px-8 py-6 border-b border-[rgba(255,255,255,0.06)]">
            <div>
              ...
              <p className="text-slate-400 mt-1">
                Monitoring 1,240 students across 12 STEM departments.
              </p>
            </div>
                    ...
                    {classrooms.map((c) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          <span
                            className={`font-bold flex items-center justify-end gap-1 ${c.trendUp ? "text-emerald-500" : "text-rose-500"}`}
                          >
                            <span className="material-symbols-outlined text-[14px]">
                              {c.trendUp ? "trending_up" : "trending_down"}
                            </span>
                            {c.trend}
                          </span>
                        </td>
