    ...
    <div className="relative flex min-h-screen flex-col bg-[#10221c] text-white overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="px-6 lg:px-10 py-6 border-b border-[rgba(255,255,255,0.07)]">
          <nav className="flex flex-wrap gap-2 mb-4 text-sm">
            <a href="/dashboard/content" className="text-slate-500 hover:text-[#13eca4]">My Courses</a>
            <span className="text-slate-600">/</span>
            <a href={`/dashboard/courses/create/step1?courseId=${courseId}`} className="text-slate-500 hover:text-[#13eca4]">{course?.title || "Course"}</a>
            <span className="text-slate-600">/</span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            ...
            <Link href={`/dashboard/courses/create/preview?courseId=${courseId}`} className="flex items-center gap-2 h-10 px-4 rounded-lg bg-[#1a2e27] text-white text-sm font-bold border border-[rgba(255,255,255,0.1)] hover:bg-[rgba(255,255,255,0.08)] transition-colors">
          ...
          <div className="mt-8 flex border-b border-[rgba(255,255,255,0.07)] gap-8">
            {[
              { label: "Content Builder",    num: "1", active: false, href: `/dashboard/courses/create/step2?courseId=${courseId}` },
              { label: "Interactive Tasks",   num: "2", active: false, href: `/dashboard/courses/create/step2?courseId=${courseId}` },
      ...
      <footer className="border-t border-[rgba(255,255,255,0.07)] bg-[#10221c] p-4 flex justify-between items-center px-10 shrink-0">
        ...
        <div className="flex gap-4">
          <Link href={`/dashboard/courses/create/step2?courseId=${courseId}`} className="px-6 py-2 rounded-lg text-slate-400 font-bold text-sm hover:bg-[rgba(255,255,255,0.06)] transition-colors">
            Back to Curriculum
          </Link>
          <Link href={`/dashboard/courses/create/step4?courseId=${courseId}`} className="px-8 py-2 rounded-lg bg-[#13eca4] text-[#10221c] font-black text-sm shadow-lg shadow-[rgba(19,236,164,0.15)] hover:opacity-90 transition-opacity">
            Next: Review &amp; Publish
          </Link>
        </div>
      </footer>
