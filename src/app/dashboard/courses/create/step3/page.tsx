              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div
                    ...
                    className="p-5 rounded-xl bg-(--bg-card) border-2 border-dashed border-(--border-subtle) flex flex-col items-center justify-center gap-2 text-center py-8 cursor-pointer hover:border-[rgba(19,236,164,0.4)] hover:bg-[rgba(19,236,164,0.03)] transition-all"
                  >
                    {uploading ? (
                      <>
