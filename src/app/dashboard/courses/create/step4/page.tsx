    ...
    <div className="relative flex min-h-screen flex-col bg-(--bg-page) text-(--text-base) overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-[rgba(255,255,255,0.07)] bg-(--bg-page) px-10 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="w-10 h-10 rounded-full bg-primary-green/15 border-2 border-[rgba(19,236,164,0.25)] flex items-center justify-center text-primary-green font-bold text-sm">
                  ...
                  {checklistItemsDef.map((item, i) => (
                    ...
                    >
                      <input
                        ...
                        className="h-5 w-5 rounded border-(--border-accent) text-primary-green focus:ring-[#13eca4] bg-(--input-bg)"
                      />
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <button className="w-full py-2 border-2 border-dashed border-(--border-subtle) rounded-xl text-(--text-faint) hover:text-primary-green hover:border-[rgba(19,236,164,0.4)] text-sm font-medium transition-all flex items-center justify-center gap-2">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="h-6 w-6 rounded-full border-(--border-accent) text-primary-green focus:ring-[#13eca4] bg-(--input-bg)"
                    />
                  ...
                  <div className="pt-6">
                    <button
                      ...
                      className="w-full bg-primary-green hover:opacity-90 text-(--text-base) font-black text-xl py-5 rounded-xl transition-all flex items-center justify-center gap-3 shadow-lg shadow-primary-green/20 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {publishing ? (
                        <>
                ...
                <div className="bg-(--bg-card) rounded-xl overflow-hidden border border-(--border-subtle) shadow-xl">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2 mt-4">
                      <span className="px-2 py-1 bg-primary-green/10 text-primary-green text-[10px] font-bold rounded uppercase">
