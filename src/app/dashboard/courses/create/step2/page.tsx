    ...
    <div className="flex h-screen flex-col bg-(--bg-page) text-(--text-base) overflow-hidden">
      ...
      <header className="flex items-center justify-between border-b border-(--border-subtle) bg-(--bg-page) px-8 py-3 shrink-0">
        <div className="flex items-center gap-4">
          <div className="w-8 h-8 bg-primary-green rounded-lg flex items-center justify-center text-(--text-base)">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex gap-3">
            ...
            <Link
              ...
              className="h-10 px-4 rounded-lg bg-primary-green text-white text-sm font-bold hover:opacity-90 transition-opacity flex items-center"
            >
              Next: Facilitation
            </Link>
          </div>
        ...
        <aside className="w-72 border-r border-(--border-subtle) bg-(--bg-page) flex flex-col shrink-0">
          <div className="p-6 border-b border-(--border-subtle)">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] bg-primary-green/15 text-primary-green px-2 py-0.5 rounded-full font-bold">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2">
            {lessonSteps.map((s, i) => (
              <div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-all ${
                  s.active
                    ? "bg-primary-green/8 border border-[rgba(19,236,164,0.25)] text-primary-green"
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg border-2 border-dashed border-(--border-subtle) text-(--text-faint) hover:border-[rgba(19,236,164,0.4)] hover:text-primary-green transition-all mt-4 group"
            >
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          className="rounded border-(--border-accent) text-primary-green focus:ring-[#13eca4] bg-(--bg-card)"
                        />
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all ${
                        b.primary
                          ? "bg-primary-green/15 border border-(--border-strong) text-primary-green hover:bg-[rgba(19,236,164,0.25)]"
