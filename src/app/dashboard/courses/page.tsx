    ...
    <div className="min-h-screen bg-(--bg-page)">
      <header className="sticky top-0 z-10 bg-[rgba(16,34,28,0.8)] backdrop-blur-md border-b border-[rgba(45,212,191,0.1)] px-8 h-16 flex items-center justify-between">
        ...
        <Link
          ...
          style={{ background: "var(--primary-green)", color: "#0d1f1a" }}
        >
      ...
      <div className="px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            <div
              key={label}
              className="flex items-center gap-4 p-5 bg-(--bg-card) rounded-2xl border border-[rgba(45,212,191,0.08)] cursor-pointer hover:border-[rgba(45,212,191,0.2)] transition-colors"
              onClick={() =>
                setFilterStatus(
          ...
          <div className="flex gap-2 flex-wrap">
            {["all", "published", "pending_review", "draft"].map((s) => (
              <button
                ...
                style={
                  filterStatus === s
                    ? { background: "var(--primary-green)", color: "#0d1f1a", borderColor: "var(--primary-green)" }
                    : {
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((course) => {
              ...
              return (
                <div
                  key={course.id}
                  className="bg-(--bg-card) rounded-2xl border border-[rgba(45,212,191,0.08)] p-5 flex items-center gap-4 hover:border-[rgba(45,212,191,0.2)] transition-colors group"
                >
                  <div
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Link
                        ...
                        className="p-2 rounded-lg text-(--text-muted) hover:text-(--primary-green) hover:bg-[rgba(45,212,191,0.08)] transition-colors"
                        title="Edit course"
                      >
