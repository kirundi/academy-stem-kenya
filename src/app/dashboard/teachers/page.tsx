...
export default function TeacherManagementPage() {
  ...
  const { teachers, loading, error } = useGlobalAdminData();
        ...
        <section className="flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-(--primary-green) text-[#10221c] text-sm font-bold hover:opacity-90 transition-opacity"
            >
                    ...
                    return (
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm bg-[rgba(45,212,191,0.1)] text-(--primary-green)">
