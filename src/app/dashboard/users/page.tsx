          ...
          >
            ...
            {invites.filter((i) => i.status === "pending").length > 0 && (
              <span className={`text-xs px-1.5 py-0.5 rounded-full font-bold ${
                activeTab === "invites" ? "bg-(--bg-page) text-primary-green" : "bg-primary-green/15 text-primary-green"
              }`}>
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-right relative">
                        <div className="flex items-center justify-end gap-1">
                          <button className="p-2 hover:bg-primary-green/8 rounded-lg text-(--text-muted) hover:text-primary-green transition-colors">
                                    ...
                                    <button
                                      ...
                                      className={`w-full text-left px-4 py-2.5 text-sm transition-colors flex items-center gap-2 ${
                                        u.role === role
                                          ...
                                          : "text-(--text-muted) hover:bg-[rgba(255,255,255,0.05)]"
                                      }`}
                                    >
                                      <span
                                  ...
                                  {canManageUsers && (
                                    <div className="border-t border-(--border-subtle)">
                                      <button
                                        ...
                                        className="w-full text-left px-4 py-2.5 text-sm text-(--text-muted) hover:bg-[rgba(255,255,255,0.05)] transition-colors flex items-center gap-2"
                                      >
          ...
          <div className="bg-(--bg-card) rounded-2xl border border-[rgba(19,236,164,0.08)] overflow-hidden">
            <div className="px-6 py-4 border-b border-(--border-subtle) flex items-center justify-between">
              ...
              <button
                ...
                className="p-2 rounded-lg text-(--text-muted) hover:text-primary-green hover:bg-primary-green/8 transition-colors disabled:opacity-50"
                title="Refresh"
              >
                            ...
                            <div className="flex items-center justify-end gap-1">
                              {inv.status !== "accepted" && (
                                <button
                                  ...
                                  className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold text-primary-green hover:bg-primary-green/8 transition-colors disabled:opacity-50"
                                  title="Resend invite"
                                >
                                  {isActioning ? (
          ...
          >
            ...
            {inviteResult ? (
              <div className="px-6 py-6">
                ...
                <button
                  onClick={closeInviteModal}
                  className="mt-5 w-full bg-primary-green text-white font-bold text-sm py-2.5 rounded-lg hover:opacity-90 transition-opacity"
                >
                  Done
                </button>
              </div>
              ...
              <div className="px-6 py-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-primary-green text-white font-bold text-sm py-2.5 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {inviteLoading ? (
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-(--border-subtle) flex items-center gap-3">
              ...
              <button
                onClick={() => setRolesUser(null)}
                className="border border-(--border-subtle) text-(--text-muted) font-semibold text-sm px-5 py-2 rounded-lg hover:bg-(--glass-bg) transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="bg-primary-green text-white font-bold text-sm px-5 py-2 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center gap-2"
              >
                {rolesSaving && (
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-(--border-subtle) flex items-center gap-3">
              ...
              <button
                ...
                disabled={permSaving}
                className="bg-primary-green text-white font-bold text-sm px-5 py-2 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
              >
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setConfirmAction(null)}
                className="flex-1 border border-(--border-subtle) text-(--text-muted) font-semibold text-sm py-2.5 rounded-lg hover:bg-(--glass-bg) transition-colors"
              >
                Cancel
              </button>
              <button
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-(--border-subtle) flex items-center gap-3">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-primary-green text-white font-bold text-sm py-2 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
              >
                <span className="material-symbols-outlined text-[18px]">download</span>
                Download CSV
              </button>
