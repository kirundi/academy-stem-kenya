              ...
              <div className="space-y-6">
                <div className="bg-(--bg-card) rounded-xl border border-slate-800 p-7">
                  ...
                  <div className="flex items-center justify-between p-4 bg-(--bg-page)/50 rounded-xl border border-slate-700">
                    ...
                    <a href="/auth/change-password" className="px-4 py-2 bg-(--bg-card) border border-slate-700 text-slate-200 text-sm font-bold rounded-lg hover:border-[rgba(168,85,247,0.5)] transition-colors">
                      Change Password
                    </a>
                  </div>
                </div>
