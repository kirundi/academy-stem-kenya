        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/teacher/classroom" className="text-[#13eca4] text-sm font-semibold hover:underline flex items-center gap-1">
                Manage all
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1a2e27] rounded-2xl border border-[rgba(19,236,164,0.08)] overflow-hidden">
              <div className="px-5 py-4 border-b border-[rgba(255,255,255,0.06)] flex items-center justify-between">
                ...
                <Link href="/teacher/grading" className="text-[#13eca4] text-xs font-semibold hover:underline">
                  View all
                </Link>
              </div>
