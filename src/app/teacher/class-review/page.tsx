      ...
      <div className="fixed top-0 left-60 right-0 z-20 bg-[rgba(16,34,28,0.95)] backdrop-blur-md border-b border-[rgba(255,255,255,0.06)] h-14 flex items-center justify-between px-8">
        ...
        <div className="flex items-center gap-5">
          <nav className="hidden md:flex items-center gap-5 text-sm">
            <a href="/teacher/classroom" className="text-slate-400 hover:text-[#13eca4] transition-colors">Classrooms</a>
            <a href="/teacher/courses" className="text-slate-400 hover:text-[#13eca4] transition-colors">Curriculum</a>
            <a href="/teacher/grading" className="text-slate-400 hover:text-[#13eca4] transition-colors">Grades</a>
          </nav>
          <button
